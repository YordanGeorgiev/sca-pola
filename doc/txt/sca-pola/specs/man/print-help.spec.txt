...
doPrintHelp(){
   ...
   #------------------------------------------------------------------------------
      ...
      #--------------------------------------------------------
		...
		You must specify the files to be be included in the full package from the met/sca-pola.dev 
		file
      ...
      #------------------------------------------------------------------------------
		...
		where <<full_package>> should look like: sca-pola.0.0.2.prd.20160702_181412.ysg-host-name.zip
