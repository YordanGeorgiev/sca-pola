# src/bash/sca-pola/funcs/log-test-run-entry.test.sh
...
doTestLogTestRunEntry(){
	...
	cat doc/txt/sca-pola/tests/log-test-run-entry.test.txt
...
# eof file: src/bash/sca-pola/funcs/log-test-run-entry.test.sh
