# src/bash/sca-pola/funcs/create-relative-7z-package.spec.sh
...
doSpecCreateRelative7zPackage(){
	...
	cat doc/txt/sca-pola/specs/pckg/create-relative-7z-package.spec.txt
...
# eof file: src/bash/sca-pola/funcs/create-relative-7z-package.spec.sh
