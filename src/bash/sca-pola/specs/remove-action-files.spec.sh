# src/bash/sca-pola/funcs/remove-action-files.spec.sh
...
doSpecRemoveActionFiles(){
	...
	cat doc/txt/sca-pola/specs/remove-action-files.spec.txt
...
# eof file: src/bash/sca-pola/funcs/remove-action-files.spec.sh
