...
# v1.0.9
# ---------------------------------------------------------
# cat doc/txt/sca-pola/funcs/clone-project.func.txt
# ---------------------------------------------------------
doCloneProject(){
   ...
   export tgt_proj='phz'
   export global_cnf_dir='/vagrant/csitea/cnf/projects/sca-pola'
...
# eof file: src/bash/sca-pola/funcs/clone-project.func.sh
