# src/bash/sca-pola/funcs/log-test-run-entry.help.sh
...
doHelpLogTestRunEntry(){
	...
	cat doc/txt/sca-pola/helps/log-test-run-entry.help.txt
...
# eof file: src/bash/sca-pola/funcs/log-test-run-entry.help.sh
