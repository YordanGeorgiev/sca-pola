# src/bash/sca-pola/funcs/remove-package-files.help.sh
...
doHelpRemovePackageFiles(){
	...
	cat doc/txt/sca-pola/helps/remove-package-files.help.txt
...
# eof file: src/bash/sca-pola/funcs/remove-package-files.help.sh
